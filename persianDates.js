 ...
 * Persian Date
 * Ahmadreza Vakil
 * https://github.com/AhmadVakil/Persian-Dates-Time
 *
 */
!function (e, t) {
    ...
    return function (e) {
                ...
                return r(t, [{
                    ...
                    key: "format", value: function (e) {
                        function t(e) {
                            switch (e) {
                                case"a":
                                    return n ? r.hour >= 12 ? "Ø¨ Ø¸" : "Ù‚ Ø¸" : r.hour >= 12 ? "PM" : "AM";
                                case"H":
                                    return s(r.hour);
                                case"HH":
                                    return s(d(r.hour, 2));
        ...
        e.exports = {
            ...
            persian: {
                ...
                monthsShort: ["ÙØ±Ùˆ", "Ø§Ø±Ø¯", "Ø®Ø±Ø¯", "ØªÛŒØ±", "Ù…Ø±Ø¯", "Ø´Ù‡Ø±", "Ù…Ù‡Ø±", "Ø¢Ø¨Ø§", "Ø¢Ø°Ø±", "Ø¯ÛŒ", "Ø¨Ù‡Ù…", "Ø§Ø³Ù"],
                weekdays: ["Ø´Ù†Ø¨Ù‡", "ÛŒÚ©Ø´Ù†Ø¨Ù‡", "Ø¯ÙˆØ´Ù†Ø¨Ù‡", "Ø³Ù‡ Ø´Ù†Ø¨Ù‡", "Ú†Ù‡Ø§Ø± Ø´Ù†Ø¨Ù‡", "Ù¾Ù†Ø¬Ø´Ù†Ø¨Ù‡", "Ø¬Ù…Ø¹Ù‡"],
                weekdaysShort: ["Ø´", "ÛŒ", "Ø¯", "Ø³", "Ú†", "Ù¾", "Ø¬"],
                weekdaysMin: ["Ø´", "ÛŒ", "Ø¯", "Ø³", "Ú†", "Ù¾", "Ø¬"],
                persianDaysName: ["Ø§ÙˆØ±Ù…Ø²Ø¯", "Ø¨Ù‡Ù…Ù†", "Ø§ÙˆØ±Ø¯ÛŒØ¨Ù‡Ø´Øª", "Ø´Ù‡Ø±ÛŒÙˆØ±", "Ø³Ù¾Ù†Ø¯Ø§Ø±Ù…Ø°", "Ø®ÙˆØ±Ø¯Ø§Ø¯", "Ø§Ù…Ø±Ø¯Ø§Ø¯", "Ø¯ÛŒ Ø¨Ù‡ Ø¢Ø°Ø²", "Ø¢Ø°Ø²", "Ø¢Ø¨Ø§Ù†", "Ø®ÙˆØ±Ø´ÛŒØ¯", "Ù…Ø§Ù‡", "ØªÛŒØ±", "Ú¯ÙˆØ´", "Ø¯ÛŒ Ø¨Ù‡ Ù…Ù‡Ø±", "Ù…Ù‡Ø±", "Ø³Ø±ÙˆØ´", "Ø±Ø´Ù†", "ÙØ±ÙˆØ±Ø¯ÛŒÙ†", "Ø¨Ù‡Ø±Ø§Ù…", "Ø±Ø§Ù…", "Ø¨Ø§Ø¯", "Ø¯ÛŒ Ø¨Ù‡ Ø¯ÛŒÙ†", "Ø¯ÛŒÙ†", "Ø§Ø±Ø¯", "Ø§Ø´ØªØ§Ø¯", "Ø¢Ø³Ù…Ø§Ù†", "Ø²Ø§Ù…ÛŒØ§Ø¯", "Ù…Ø§Ù†ØªØ±Ù‡ Ø³Ù¾Ù†Ø¯", "Ø§Ù†Ø§Ø±Ø§Ù…", "Ø²ÛŒØ§Ø¯ÛŒ"]
            }
        }
    }, function (e, t, a) {
        "use strict";
